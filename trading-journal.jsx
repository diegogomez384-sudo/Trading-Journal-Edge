    ...
    <div style={{ fontFamily: "'DM Mono','Courier New',monospace", background: isDark ? "#06060d" : "#f9f9f2", minHeight: "100vh", color: "#d8d8ec" }}>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .nb{background:rgba(255,255,255,0.04);border:none;cursor:pointer;padding:10px 18px;border-radius:12px;font-family:'DM Mono',monospace;font-size:11px;letter-spacing:.08em;transition:all .4s cubic-bezier(0.2, 0.8, 0.2, 1);color:#8a8aa8;text-transform:uppercase;position:relative;backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px);}
        ...
        .nb:hover:not(.on){color:#d8d8ec;background:rgba(255,255,255,0.07);}
        ...
        <div style={{
          ...
          <style>
            {`
              ...
              .glass-tab:hover:not(.glass-active) {
            ...
            <div>
              ...
              <div className="card" style={{ marginBottom: 20 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 16 }}>
                  <p style={{ fontFamily: "Syne,sans-serif", fontWeight: 700, fontSize: 16, color: "#7fffb2" }}>Today's Events</p>
              ...
              <div className="card" style={{ marginBottom: 20 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 16 }}>
                  <p style={{ fontFamily: "Syne,sans-serif", fontWeight: 700, fontSize: 16, color: "#7ca5d4" }}>Upcoming Events</p>
              ...
              <div className="card">
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                  {[
                    { stars: 5, label: "Extreme Impact", color: "#ff0033", example: "FOMC Rate Decision, NFP, CPI" },
                    { stars: 4, label: "High Impact", color: "#ff5566", example: "PPI, Retail Sales, Consumer Confidence" },
                    { stars: 3, label: "Medium Impact", color: "#ff9900", example: "GDP, PMI, Jobless Claims" },
